        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled) {
                    ...
                    if (onHeadHeightChangedListener != null){
                        onHeadHeightChangedListener.onHeadHeightChanged(mRefreshHeader.getVisibleHeight());
                    }
                    if (mRefreshHeader.getVisibleHeight() > 0 && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
//                        Log.e("getVisiableHeight", "getVisiableHeight = " + mRefreshHeader.getVisibleHeight());
//                        Log.e("getVisiableHeight", " mRefreshHeader.getState() = " + mRefreshHeader.getState());
                        if (mRefreshHeader!=null) mRefreshHeader.setTime();
                        return false;
                    }
                }
                break;
...
//        return false;
    ...
    private OnHeadHeightChangedListener onHeadHeightChangedListener;
    public void setOnHeadHeightChangedListener( OnHeadHeightChangedListener onHeadHeightChangedListener){
        this.onHeadHeightChangedListener= onHeadHeightChangedListener;
    }
    public interface OnHeadHeightChangedListener{
        void onHeadHeightChanged(int heigh);
    }
}
